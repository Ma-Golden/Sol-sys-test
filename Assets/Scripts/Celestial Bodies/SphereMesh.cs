...
public class SphereMesh
{
    ...
    static readonly Vector3[] baseVertices = { up, left, back, right, forward, down }; // shorthand for Vector3's
    ...
    public SphereMesh(int resolution)
    {
        ...
        for (int i = 0; i < vertexPairs.Length; i += 2) // skip 2 to pass over each pais
        {
    ...
    public class Edge
    {
        ...
        public Edge(int[] vertxIndices)
        {
            this.vertexIndices = vertxIndices;
        }
    }
